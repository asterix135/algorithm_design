...
def recursive_matrix_multiplication(x_matrix, y_matrix):
    ''' Not using Strassens algorithm - shouldn't beat brute force in speed
    Assumes 2 square matrices of same size
    :param x_matrix:
    :param y_matrix:
    :return z_matrix:
    '''
